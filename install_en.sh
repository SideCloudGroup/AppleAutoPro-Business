#!/bin/sh
# AppleAutoPro-Business installation script
IFS=$'\n\t'
...
repo="SideCloudGroup/AppleAutoPro-Business"
filename="AppleAutoPro-Business"
...
echo -e "${YELLOW}Enter installation path (default /opt/AppleAutoPro-Business):${NC}"
read install_path
install_path=${install_path:-/opt/AppleAutoPro-Business}
